...
public class ListDialog<T extends AbstractEntity & DictEntity> extends AbstractDialog {
	...
	private ListDialogController<T> controller;
	...
	public ListDialog(JFrame parentFrame, String name, ListDialogController<T> controller, Dimension size, int mode) {
	...
	public ListDialog(JDialog parentDialog, String name, ListDialogController<T> controller, Dimension size, int mode) {
	...
	public ListDialog(JFrame parentFrame, String name, ListDialogController<T> controller, int mode) {
		this(parentFrame, name, controller, new Dimension(400,500), mode);
	}

	public ListDialog(JDialog parentDialog, String name, ListDialogController<T> controller, int mode) {
		this(parentDialog, name, controller, new Dimension(400,500), mode);
	}


	public ListDialog(JFrame parentFrame, String name, ListDialogController<T> controller) {
		this(parentFrame, name, controller, VIEW_MODE);
	}

	public ListDialog(JDialog parentDialog, String name, ListDialogController<T> controller) {
		this(parentDialog, name, controller, VIEW_MODE);		
	}

	public ListDialog(JFrame parentFrame, ListDialogController<T> controller) {
		this(parentFrame, "", controller);
	}

	public ListDialog(JDialog parentDialog, ListDialogController<T> controller) {
